...
df_sensor = pd.read_csv('/Users/batistajunior/desafio-de-dados-fieldpro/Sensor_FieldPRO.csv')
df_estacao = pd.read_csv('/Users/batistajunior/desafio-de-dados-fieldpro/Estacao_Convencional.csv')
...
# Salvando o modelo treinado em um arquivo 'modelo_trein
